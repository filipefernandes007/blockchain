<?php
    ...
    class UnitTest extends TestCase
    {
        ...
        public function testBlockDataInterface() : void {
            $voter = new Vote(hexdec(\uniqid('__voter', false)), Vote::YES);

            $this->assertInstanceOf(Vote::class, unserialize($voter->getData()));
